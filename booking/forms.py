...
class BookingForm(forms.ModelForm):
    ...
    **Attributes**
    ...
    service = forms.ChoiceField(
        ...
        widget=forms.Select(attrs={"class": "form-control"}),  # Set widget attributes for styling
    )
    ...
    booking_date = forms.DateField(
        ...
        widget=forms.DateInput(
            attrs={"class": "form-control datepicker", "type": "date", "min": current_date}  # Set widget attributes for styling and minimum date
        ),
    )
    ...
    class Meta:
        ...
        fields = ["service", "booking_date", "booking_time", "message"]  # Specify fields to be included in the form
        widgets = {
