...
This module contains URL patterns for directing requests
to the appropriate views in the 'booking' app.

**URL Patterns**
- '' : Directs to the 'create_booking' view defined in the 'views' module.
- 'edit/<int:booking_id>' : Directs to the 'edit_booking' view defined
in the 'views' module.
- 'delete/<int:booking_id>' : Directs to the 'delete_booking' view defined
in the 'views' module.
"""
urlpatterns = [
