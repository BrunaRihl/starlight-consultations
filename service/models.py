...
class Service(models.Model):
    ...
    **Attributes**
    - `name` : The name of the service. It is a required field and cannot be blank.
    - `consultant` : The name of the consultant offering the service. It is a required field and cannot be blank.
    """
