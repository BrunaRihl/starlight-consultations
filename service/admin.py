...
class ServiceAdmin(admin.ModelAdmin):
    """
    Customizes the display of Service model instances in the Django admin interface.
    
    **Attributes**
    - `list_display` : Determines the fields to display in the admin interface list view.
    """
    list_display = [
        "name",
        "consultant",
